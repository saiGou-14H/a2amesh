...
| [ADR-039](ADR-039_Auth_Replay_Claim_V1.md) | AuthProof replay claim 的受信入口、EVALSHA ABI、失败边界与 A0 vertical slice | Accepted for implementation candidate（尚无代码/门禁/独立复审） | C2 §9.3 步骤3A0 |
