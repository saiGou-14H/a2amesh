...
最新可实施设计入口见 [A2AMesh V1.1 设计文档索引](docs/specs/README.md)，包含 8 份当前专项文档及 1 份开发实施计划；V1.0 作为不可变历史版本保留。

## 最新架构

![A2AMesh V1.1 Architecture](docs/assets/A2AMesh_V1.1_Architecture.png)
...
[查看可缩放 SVG](docs/assets/A2AMesh_V1.1_Architecture.svg) · [查看自包含 HTML](docs/assets/A2AMesh_V1.1_Architecture.html)
